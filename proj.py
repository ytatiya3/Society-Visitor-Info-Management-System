...
#----------------------------------------Button Frame----------------------------------------------------------------------        
        ...
        Buttonframe=Frame(MainFrame,bd=2,width=1920,height=70,padx=18,pady=10,bg="blue",relief=RIDGE)
        Buttonframe.pack(side=BOTTOM)

#---------------------------------------Data Frame-------------------------------------------------------------------------
        Dataframe=Frame(MainFrame,bd=1,width=1920,height=500,padx=18,pady=10,bg="gray",relief=RIDGE)
